module SeedCms
  module Concerns
    module Searchable
      ...
      included do
        has_many :search_data, class_name: 'SeedCms::EntrySearchData'
      ...
      module ClassMethods
        ...
        def search(query)
          select('DISTINCT ON (entry_id) entry_id, seed_cms_entries.*').
            joins(:search_data).
      ...
      def update_search_index
        SeedCms::EntrySearchData.index_entry_data(id, search_attributes)
      end
    end
  end
end